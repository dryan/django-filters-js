...
const _timeSince = (
  ...
  let count: number, seconds: number, name: string, index: number;
...
export const timesince = (
  ...
  compareTo: Date | undefined = undefined
): string => _timeSince(value, compareTo);
export const timeuntil = (
  value: ParseDateInput,
  compareTo: Date | undefined = undefined
): string => _timeSince(value, compareTo, true);
